...
// Make sure to import your RegisterPage if not already imported
// import 'package:your_app/features/auth/pages/register_page.dart';
...
Widget _findRegisterPage(BuildContext context) {
  try {
    // Replace with your actual RegisterPage import if needed
    // ignore: prefer_const_constructors
    return RegisterPage();
  } catch (_) {
    return Scaffold(body: Center(child: Text('RegisterPage not found')));
  }
}
